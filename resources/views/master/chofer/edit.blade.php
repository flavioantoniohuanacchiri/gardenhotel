...
<div class="right_col" role="main">
        ...
        <h1 class="text-uppercase">{{ trans('master.edit module', ['module' => $chofer->nombre ]) }}</h1>
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                                <div class="x_content">
                                        ...
                                        {!! Form::model($chofer,['method' => 'PATCH', 'route'=>['chofer.update',$chofer->id], 'class'=> 'form-horizontal']) !!}
