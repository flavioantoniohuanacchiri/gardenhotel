...
<div class="right_col" role="main">
        ...
        <h1 class="text-uppercase">{{ trans('master.edit module', ['module' => $gasto->nombre ]) }}</h1>
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                                <div class="x_content">
                                        ...
                                        {!! Form::model($gasto,['method' => 'PATCH', 'route'=>['gasto.update',$gasto->id], 'class'=> 'form-horizontal']) !!}
