...
<div class="right_col" role="main">
        ...
        <h1 class="text-uppercase">{{ trans('master.edit module', ['module' => $banco->nombre ]) }}</h1>
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                                <div class="x_content">
                                        ...
                                        {!! Form::model($banco,['method' => 'PATCH', 'route'=>['banco.update',$banco->id], 'class'=> 'form-horizontal']) !!}
