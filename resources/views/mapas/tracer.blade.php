...
<script>
	...
	function init()
	{
		screen = new Ajax.PeriodicalUpdater('', 'gps_data_reader.php', { method: 'get', frequency: 5.0,onSuccess: function(t) {
	...
	function initalizeMap() {
       ...
       var goalLonLat = new OpenLayers.LonLat(-1.985959, 43.320920).transform(new OpenLayers.Projection("EPSG:4326"), map.getProjectionObject());
        ...
        icon[0] = new OpenLayers.Icon('http://www.saulcintero.com/gpstracker/img/marker1.png',size,offset);
		icon[1] = new OpenLayers.Icon('http://www.saulcintero.com/gpstracker/img/marker2.png',size,offset);
		icon[2] = new OpenLayers.Icon('http://www.saulcintero.com/gpstracker/img/marker3.png',size,offset);
		icon[3] = new OpenLayers.Icon('http://www.saulcintero.com/gpstracker/img/marker4.png',size,offset);
		icon[4] = new OpenLayers.Icon('http://www.saulcintero.com/gpstracker/img/marker5.png',size,offset);
		icon[5] = new OpenLayers.Icon('http://www.saulcintero.com/gpstracker/img/marker6.png',size,offset);
		icon[6] = new OpenLayers.Icon('http://www.saulcintero.com/gpstracker/img/marker7.png',size,offset);
       for(var i = 0; i < teamData.length; i++) {
        	...
        	var team1Marker =new OpenLayers.Marker(team1LonLat,icon[i]);
		...
		team2Popup = new OpenLayers.Popup("Equipo2",
						team2LonLat,
						new OpenLayers.Size(145,52),
